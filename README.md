...
| `business-metrics` | Reduces a business to seven numbers and a marketing goal from its SOM |
...
[`mattpocock/skills`](https://github.com/mattpocock/skills); the other three stand alone.
